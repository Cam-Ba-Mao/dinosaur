...
gsap.fromTo(
    ...
    { duration: 0.6, repeat: -1, ease: "sine", x: "-=100", repeatRefresh: true }
);
gsap.fromTo(
    dust1,
    {
    ...
    { duration: 0.6, repeat: -1, ease: "sine.in", y: "-=50", repeatRefresh: true }
);
...
gsap.fromTo(
    ...
    { delay: 0.2, duration: 0.6, repeat: -1, ease: "sine", x: "-=150", repeatRefresh: true }
);
gsap.fromTo(
    dust2,
    {
    ...
    { delay: 0.2, duration: 0.6, repeat: -1, ease: "sine.in", y: "-=30", repeatRefresh: true }
);
